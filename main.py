...
====================================
Duas URLs:
  /gestor   → dashboard + upload de faturas + geração de relatório
  /usina    → dashboard somente leitura
...
HISTORICO_ECONOMIA = {
    "Real Evolution": [
        {"mes":"Mai/25","economia":728},{"mes":"Jun/25","economia":987},
        {"mes":"Jul/25","economia":986},{"mes":"Ago/25","economia":987},
        {"mes":"Set/25","economia":1118},{"mes":"Out/25","economia":870},
        {"mes":"Nov/25","economia":870},{"mes":"Dez/25","economia":870},
        {"mes":"Jan/26","economia":870},{"mes":"Fev/26","economia":869},
        {"mes":"Mar/26","economia":870},{"mes":"Abr/26","economia":728},
        {"mes":"Mai/26","economia":2779},
    ],
    "Bello Trigo": [
        {"mes":"Ago/25","economia":2085},{"mes":"Set/25","economia":2795},
        {"mes":"Out/25","economia":2687},{"mes":"Nov/25","economia":2672},
        {"mes":"Dez/25","economia":2801},{"mes":"Jan/26","economia":2914},
        {"mes":"Fev/26","economia":2732},{"mes":"Mar/26","economia":2931},
        {"mes":"Abr/26","economia":3285},{"mes":"Mai/26","economia":3146},
    ],
    "Oasis Design": [
        {"mes":"Mai/25","economia":3824},{"mes":"Jun/25","economia":3591},
        {"mes":"Jul/25","economia":3670},{"mes":"Ago/25","economia":4353},
        {"mes":"Set/25","economia":4284},{"mes":"Out/25","economia":4101},
        {"mes":"Nov/25","economia":4043},{"mes":"Dez/25","economia":4497},
        {"mes":"Jan/26","economia":4592},{"mes":"Fev/26","economia":4508},
        {"mes":"Mar/26","economia":4499},{"mes":"Abr/26","economia":4300},
        {"mes":"Mai/26","economia":4008},
    ],
    "Versato": [
        {"mes":"Nov/25","economia":2404},{"mes":"Dez/25","economia":2769},
        {"mes":"Jan/26","economia":2852},{"mes":"Fev/26","economia":2620},
        {"mes":"Mar/26","economia":3068},{"mes":"Abr/26","economia":2703},
        {"mes":"Mai/26","economia":2305},
    ],
    "SQS 314": [
        {"mes":"Mai/24","economia":566},{"mes":"Jun/24","economia":524},
        {"mes":"Jul/24","economia":507},{"mes":"Ago/24","economia":598},
        {"mes":"Set/24","economia":571},{"mes":"Out/24","economia":537},
        {"mes":"Nov/24","economia":563},{"mes":"Dez/24","economia":653},
        {"mes":"Jan/25","economia":641},
    ],
}
...
ESTADO_INICIAL = {
    ...
    "clientes":{
        "Real Evolution":{"consumo_faturavel":13820,"valor_sem_desconto":13506.58,"valor_com_desconto":10727.64,"saldo_creditos":109513,"ref_mes":"Mai/26","status":"ativo","creditos_utilizados":13920,"tarifa_neo":0.97030},
        "SQS 314":       {"consumo_faturavel":None,"valor_sem_desconto":None,"valor_com_desconto":None,"saldo_creditos":None,"ref_mes":None,"status":"aguardando","creditos_utilizados":None,"tarifa_neo":0.99926},
        "Oasis Design":  {"consumo_faturavel":20380,"valor_sem_desconto":19655.68,"valor_com_desconto":15647.76,"saldo_creditos":69713,"ref_mes":"Mai/26","status":"ativo","creditos_utilizados":20480,"tarifa_neo":0.95975},
        "Bello Trigo":   {"consumo_faturavel":15541,"valor_sem_desconto":15335.84,"valor_com_desconto":12190.24,"saldo_creditos":26677,"ref_mes":"Mai/26","status":"ativo","creditos_utilizados":15641,"tarifa_neo":0.98049},
        "Versato":       {"consumo_faturavel":10620,"valor_sem_desconto":11110.21,"valor_com_desconto":8805.25,"saldo_creditos":68964,"ref_mes":"Mai/26","status":"ativo","creditos_utilizados":10720,"tarifa_neo":1.03640},
    },
    "historico_mensal":[
...
def extrair_pdf(conteudo_bytes: bytes) -> dict:
    ...
    m = re.search(r'QD-\s*\d+\s+(\d{6,7})\s+chave', texto_norm)
    if not m:
        m = re.search(r'BL-\s*[\w\s]+?\s+(\d{6,7})\s+chave', texto_norm)
...
.logo-circle{{width:60px;height:60px;background:#8dc63f;border-radius:50%;
...
.section-title{{font-size:14px;font-weight:bold;color:#333;
  border-bottom:3px solid #8dc63f;padding-bottom:5px;margin-bottom:12px;margin-top:24px}}
...
.resumo-valor.green{{color:#5a9a1f}}
.resumo-valor.blue{{color:#2a6db5}}
.obs{{background:#f9f9f9;border-left:3px solid #8dc63f;
  padding:11px 15px;font-size:12px;color:#555;line-height:1.7;margin-top:8px}}
...
<div class="header">
  ...
  <div class="header-right">
    Asa Sul CLS 312 Bloco D loja 34<br>
    Brasília - DF, 70365-540<br>
    mtecenergia.com.br · (61) 3465-3366
  </div>
</div>
...
<div class="resumo-grid">
  <div class="resumo-item">
    <div class="resumo-label">Saldo de créditos</div>
    <div class="resumo-valor blue">{saldo:,} kWh</div>
  </div>
  <div class="resumo-item">
    <div class="resumo-label">Créditos cobrados</div>
    <div class="resumo-valor">{faturavel:,} kWh</div>
  </div>
  <div class="resumo-item">
    <div class="resumo-label">Valor a ser pago</div>
    <div class="resumo-valor">{BRL(vc)}</div>
  </div>
  <div class="resumo-item">
    <div class="resumo-label">Economia</div>
    <div class="resumo-valor green">{BRL(economia)}</div>
  </div>
</div>
...
<div class="footer">
  Asa Sul CLS 312 Bloco D loja 34 - Asa Sul, Brasília - DF, 70365-540<br>
  mtecenergia.com.br · (61) 3465-3366
</div>
    ...
    <section id="sec-relatorio">
      ...
      <div class="upload-card">
        ...
        <div style="margin-top:12px">
          <label style="font-size:12px;color:#9a9a94;font-weight:600;letter-spacing:.05em;text-transform:uppercase;display:block;margin-bottom:6px">
            Observações (opcional — aparecem na seção 4 do relatório)
          </label>
          <textarea id="txt-obs" rows="3"
            placeholder="Ex: Prezado cliente, pedimos desculpas pela demora no envio..."
...
async function enviarFatura() {
  ...
  try {
    ...
    if (!r.ok) {
      ...
      res.innerHTML = `
        <strong>✓ ${rj.cliente} — ${rj.ref_mes} processado com sucesso</strong>
...
:root{{
  ...
  --grn:#2d7a3a;--grn-bg:#e8f5eb;--r:10px;
}}
...
<main>
  ...
  <section>
    ...
    <div class="tbl-wrap"><table>
      <thead><tr>
        <th>Cliente</th><th class="r">Consumo (kWh)</th><th class="r">Tarifa Mtec</th>
        <th class="r">Valor sem desconto</th><th class="r">Valor com desconto</th>
        <th class="r">Saldo créditos</th><th>Contrato</th>
      </tr></thead>
      <tbody id="tbody"></tbody>
      <tfoot><tr class="tfoot">
        <td>Total</td><td class="r" id="t-kwh">—</td><td class="r">—</td>
        <td class="r" id="t-sem">—</td><td class="r" id="t-com">—</td>
        <td class="r" id="t-sal">—</td><td>—</td>
      </tr></tfoot>
    </table></div>
  </section>
  <div class="bottom">
...
async function carregar(){{
  ...
  let tKwh=0,tSem=0,tCom=0,tSal=0,tbody="";
  for(const nome of ORDEM){{
    const c=d.clientes[nome],cf=CFG[nome];
    if(!c||!cf)continue;
    const pend=c.status==="aguardando";
    tKwh+=c.consumo_faturavel||0;tSem+=c.valor_sem_desconto||0;
    tCom+=c.valor_com_desconto||0;tSal+=c.saldo_creditos||0;
    tbody+=`<tr>
      ...
      <td class="r">${{pend?'<span class="note">aguardando fatura Neoenergia</span>':'<span class="vd">'+BRL(c.valor_com_desconto)+'</span>'}}</td>
